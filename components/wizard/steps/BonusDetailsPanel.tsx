...
export function BonusDetailsPanel({ bonuses }: { bonuses: any }) {
  ...
  return (
    <motion.div
      ...
      className="bg-teal-50 dark:bg-ecoar-teal-600/8 border border-teal-200 dark:border-ecoar-teal-500/20 rounded-none p-4 space-y-3"
    >
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(bonuses.attributes).map(([attr, value]) => {
              ...
              return (
                <div key={attr} className="flex items-center gap-2 px-3 py-2 bg-ecoar-light-800 dark:bg-ecoar-light-900/10 rounded-none border border-ecoar-dark-300/30 dark:border-ecoar-light-900/20">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(bonuses.skills).map(([skill, value]) => {
              ...
              return (
                <div key={skill} className="flex items-center gap-2 px-3 py-2 bg-ecoar-light-800 dark:bg-ecoar-light-900/10 rounded-none border border-ecoar-dark-300/30 dark:border-ecoar-light-900/20">
      ...
      {(bonuses.corpo || bonuses.mente || bonuses.folego || bonuses.mana) && (
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {bonuses.corpo && (
              <div className="flex items-center gap-2 px-3 py-2 bg-ecoar-light-800 dark:bg-ecoar-light-900/10 rounded-none border border-ecoar-dark-300/30 dark:border-ecoar-light-900/20">
            ...
            {bonuses.mana && (
              <div className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-ecoar-light-900/10 rounded-none border border-slate-200 dark:border-ecoar-light-900/20">
                <Sparkles className="w-4 h-4 text-teal-600 dark:text-ecoar-teal-400" />
