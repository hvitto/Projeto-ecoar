...
export default function Footer() {
  return (
    <footer className="bg-ecoar-dark-600 dark:bg-ecoar-dark-800 border-t border-ecoar-dark-300/30 dark:border-ecoar-light-900/[0.06] mt-auto">
