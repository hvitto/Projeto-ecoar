...
export default function LoginBackground() {
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 w-full h-full pointer-events-none opacity-100 dark:opacity-0"
        style={{
      ...
      />
      <div
        className="absolute inset-0 w-full h-full pointer-events-none opacity-0 dark:opacity-100"
        style={{
