...
export default function Button({
  ...
  const baseClasses = 'flex items-center justify-center gap-2 font-medium transition-colors duration-fast disabled:opacity-50 disabled:cursor-not-allowed active:opacity-90'
  ...
  const variantClasses = {
    ...
    secondary: 'bg-ecoar-light-800 dark:bg-ecoar-light-900/[0.08] hover:bg-ecoar-light-700 dark:hover:bg-ecoar-light-900/[0.12] border border-ecoar-dark-300/30 dark:border-ecoar-light-900/[0.12] text-ecoar-dark-900 dark:text-ecoar-light-900/90',
